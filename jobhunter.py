...
def add_new_job(cursor, jobdetails):
    ...
    query = cursor.execute("INSERT INTO jobs(Job_id, company, salary, url, Title, Description, Created_at) "
               "VALUES(%s, %s, %s, %s, %s, %s, %s)", (job_id, company, salary, url, title, description, date))
